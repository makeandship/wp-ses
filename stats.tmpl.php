<div class="wrap">
    ...
    ?>
    <table>
        <tr><td><?php _e('Max24HourSend', 'wp-ses') ?>&nbsp;</td><td><?php echo $quota['Max24HourSend'] ?></td><td>&nbsp;<i><?php _e('Max email quota for 24 hours period', 'wpses') ?></i></td></tr>
        <tr><td><?php _e('MaxSendRate', 'wp-ses') ?>&nbsp;</td><td><?php echo $quota['MaxSendRate'] ?> /s</td><td>&nbsp;<i><?php _e('Max email sending rate par second', 'wpses') ?></i></td></tr>
        <tr><td><?php _e('SentLast24Hours', 'wp-ses') ?>&nbsp;</td><td><?php echo $quota['SentLast24Hours'] ?></td><td>&nbsp;<i><?php _e('Emails sent for the last 24 hours', 'wpses') ?></i></td></tr>
        <tr><td><?php _e('SendRemaining', 'wp-ses') ?>&nbsp;</td><td><?php echo $quota['SendRemaining'] ?></td><td>&nbsp;<i><?php _e('Email sending quota remaining', 'wpses') ?></i></td></tr>
        <tr><td><?php _e('SendUsage', 'wp-ses') ?>&nbsp;</td><td><?php echo $quota['SendUsage'] ?> %</td><td>&nbsp;<i><?php _e('Usage percentage per 24h', 'wpses') ?></i></td></tr>
    </table>
